...
#  Description: A program containing several recursive functions.
...
def countX(str):
	if (str == ''):
		...
		if (str[len(str)-1] == 'x'):
			return 1 + countX(str[0:len(str)-1])
		else:
			return countX(str[0:len(str)-1])
...
def countHi(str):
	if (str == '') or (len(str) == 1):
		...
		if (str[len(str)-2:len(str)] == 'hi'):
			return 1 + countHi(str[0:len(str)-1])
		else:
			return countHi(str[0:len(str)-1])
...
def changeXY(str):
	if (str == ''):
		...
		if (str[len(str)-1] == 'x'):
			return (changeXY(str[0:len(str)-1]) + 'y')
		else:
			return (changeXY(str[0:len(str)-1]) + str[len(str)-1])
...
def changePi(str):
	if (str == '') or (len(str) == 1):
		...
		if (str[len(str)-2:len(str)] == 'pi'):
			return changePi(str[0:len(str)-2]) + '3.14'
		else:
			return changePi(str[0:len(str)-1]) + str[len(str)-1]
...
def noX(str):
	if (str == ''):
		...
		if (str[len(str)-1] == 'x'):
			return (noX(str[0:len(str)-1]))
		else:
			return (noX(str[0:len(str)-1]) + str[len(str)-1])
...
def allStar(str):
	if (str == '') or (len(str) == 1):
		...
		return (allStar(str[0:len(str)-1]) + '*' + str[len(str)-1])
...
def endX(str):
	if (str == ''):
		...
		if (str[0] == 'x'):
			...
			return str[0] + endX(str[1:len(str)])
...
def countPairs(str):
	if (str == '') or (len(str) <= 2):
		...
		if (str[-1] == str[len(str)-3]):
			return 1 + countPairs(str[0:-1])
		else:
			return countPairs(str[0:-1])
...
def countAbc(str):
	if (str == '') or (len(str) <= 2):
		...
		if (str[len(str)-3:len(str)] == 'abc' or str[len(str)-3:len(str)] == 'aba'):
			return 1 + countAbc(str[0:-1])
		else:
			return countAbc(str[0:-1])
...
def count11(str):
	if (str == '') or (len(str) < 2):
		...
		if (str[len(str)-2:len(str)] == '11'):
			return 1 + count11(str[0:len(str)-2])
		else:
			return count11(str[0:-1])
...
def stringClean(str):
	if (len(str) <= 1):
		...
		if (str[-1] == str[len(str)-2]):
			return stringClean(str[0:-1])
		else:
			return stringClean(str[0:-1]) + str[-1]
...
def countHi2(str):
	if (str == '') or (len(str) < 2):
		...
		if (str[len(str)-2:len(str)] == 'hi') and (str[len(str)-3] != 'x'):
			return 1 + countHi2(str[0:len(str)-2])
		else:
			return countHi2(str[0:len(str)-1])
...
def strCount(str, sub):
	subLen = len(sub)
	if (str == '') or (len(str) < subLen):
		return 0
	else:
		if (str[-subLen:len(str)] == sub):
			return 1 + strCount(str[0:-subLen], sub)
		else:
			return strCount(str[0:-1], sub)
...
def strCopies(str, sub, n):
	...
	if (n == 0):
		...
		if (str[len(str)-subLen:len(str)] == sub):
			return strCopies(str[0:-1], sub, n-1)
		else:
			return strCopies(str[0:-1], sub, n)
